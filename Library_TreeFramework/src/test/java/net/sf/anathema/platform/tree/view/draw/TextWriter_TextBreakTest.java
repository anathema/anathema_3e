...
import static net.sf.anathema.platform.tree.view.draw.TextWriterTest.TEXT_HEIGHT;
import static net.sf.anathema.platform.tree.view.draw.TextWriterTest.TEXT_WIDTH;
