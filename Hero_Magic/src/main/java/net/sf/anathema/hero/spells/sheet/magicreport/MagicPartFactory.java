...
public class MagicPartFactory {
  ...
  public Paragraph createGroupTitle(String groupTitle) {
    Chunk title = new Chunk(groupTitle, utils.createDefaultFont(GROUP_FONT_SIZE, Font.BOLD));
  ...
  public Paragraph createCharmTitle(String charmName) {
    Chunk title = new Chunk(charmName, utils.createDefaultFont(TITLE_FONT_SIZE, Font.BOLD));
    return new Paragraph(TITLE_LEADING, title);
  }

  public Paragraph createDescriptionParagraph(String text) {
    Chunk chunk = new Chunk(text, utils.createDefaultFont(STANDARD_FONT_SIZE, Font.NORMAL));
  ...
  public Phrase createDataPhrase(String title, String value) {
    ...
    phrase.add(new Chunk(title, utils.createDefaultFont(STANDARD_FONT_SIZE, Font.BOLD)));
    phrase.add(new Chunk(value, utils.createDefaultFont(STANDARD_FONT_SIZE, Font.NORMAL)));
    return phrase;
  }
