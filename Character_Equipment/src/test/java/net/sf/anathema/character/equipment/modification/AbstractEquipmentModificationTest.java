...
import net.sf.anathema.character.equipment.character.model.stats.modification.RangeModification;
import net.sf.anathema.character.equipment.character.model.stats.modification.RateModification;
...
import net.sf.anathema.character.equipment.character.model.stats.modification.material.MaterialRangeModifier;
import net.sf.anathema.character.equipment.character.model.stats.modification.material.MaterialRateModifier;
...
public abstract class AbstractEquipmentModificationTest {
  ...
  protected final void assertFatigueModification(int expected, int original) {
    FatigueModification modification = new FatigueModification(new MaterialFatigueModifier(getBaseMaterial(), original));
    Assert.assertEquals(expected, modification.getModifiedValue(original));
  }

  protected final void assertMobilityPenaltyModification(int expected, int original) {
    MobilityPenaltyModification modification = new MobilityPenaltyModification(new MaterialMobilityPenaltyModifier(getBaseMaterial(), original));
    Assert.assertEquals(expected, modification.getModifiedValue(original));
  }
