...
public class PrerequisiteListBuilder {
  ...
  public CharmPrerequisiteList buildPrerequisiteList(Element prerequisiteListElement) throws PersistenceException {
    ...
    CharmPrerequisite[] learnPrerequisites = buildCharmPrerequisites(prerequisiteListElement);
  ...
  private List<CharmPrerequisite> buildSimpleCharmPrerequisites(Element prerequisiteListElement) {
  ...
  private List<CharmPrerequisite> buildSelectiveCharmGroups(
